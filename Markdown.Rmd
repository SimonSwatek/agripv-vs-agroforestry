...
AFS: For this study we chose to compare the agri-PV system to an agroforestry system, consisting of arable crop land and tree strips of fast-growing poplar trees. This type of AFS falls within the broad definition of silvoarable AFS or "alley cropping systems". The tree strips consist of multiple rows of trees, that are densely planted (10.000 – 15.000 trees/ha) forming a dense hedgerow-like structure, that is regularly coppiced. The width of the tree strips can range from 3-25m and can legally occupy 2-35% of the arable field to be registered as an agroforestry system and be eligible to funding (see figure 2).

Agri-PV: In ground-mounted systems, typically only the areas between the PV modules are farmed. The advantages of ground-mounted systems are primarily their lower cost and low impact on the landscape (see figure 1). Vertically arranged modules in ground-mounted systems typically have maximum electricity production in the morning and evening hours.
...
and P.Högy. 2019. Agrophotovoltaic systems: applications, challenges, and opportunities.
A review. Agronomy for Sustainable Development 39(4), S. 35
