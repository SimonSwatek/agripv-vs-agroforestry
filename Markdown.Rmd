...
Therefore, investment costs are not yet considered so these costs were obtained from open space PV (top agrar, 2021). An advisor from the LWK NRW informed us about the running costs with regard to the Agri-Pv systems. For the EEG price we have §48 (2) EEG 2023 up to and including 1,000 kWp with fixed feed-in tariff of 5.8 ct/kwh (Bayerische Landesanstalt für Landwirtschaft, 2023)
...
cumulative contribution margin over the 20 years for the two scenarios separately for the energy production on the farm by Agri-PV and Agroforestry.
...
In times of advancing climate change with serious consequences for the environment, humans
and animals, the trend away from fossil fuels towards more environmentally friendly energy
production based on renewable energy sources is becoming increasingly important. At the
same time, the area available for energy production is limited by agricultural land used for the
production of food and feed for human and animal consumption. Therefore, research has
recently been conducted on Agri-PV and Agroforestry that allow multiple use of existing
agricultural land to find a compromise between food and feed production and energy
generation based on increasing land use efficiency.
